...
a.sInstance+"_"+location.pathname,JSON.stringify(b))}catch(c){}},fnStateSaveParams:null,iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": activate to sort column ascending",sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"Primo",sLast:"Ultimo",sNext:"Successivo",sPrevious:"Precedente"},sEmptyTable:"Non ci sono elementi nella tabella",sInfo:"Mostrando da _START_ a _END_ di _TOTAL_ parcheggi totali",sInfoEmpty:"Visualizzazione da 0 a 0 di 0 trovati",
sInfoFiltered:"(trovato/i da _MAX_ parcheggi totali)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Mostra _MENU_ righe",sLoadingRecords:"Caricamento...",sProcessing:"Processing...",sSearch:"Cerca:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"Nessuna corrispondenza trovata"},oSearch:h.extend({},l.models.oSearch),sAjaxDataProp:"data",sAjaxSource:null,sDom:"lfrtip",searchDelay:null,sPaginationType:"simple_numbers",sScrollX:"",sScrollXInner:"",sScrollY:"",sServerMethod:"GET",renderer:null,rowId:"DT_RowId"};
